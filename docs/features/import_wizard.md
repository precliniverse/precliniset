...
Unlike the standard [Excel Round-Trip](groups.md#data-entry-modes), the Wizard allows you to import files that weren't generated by Precliniset. It can skip complex headers, find data based on keywords, and apply mathematical transformations on-the-fly.
